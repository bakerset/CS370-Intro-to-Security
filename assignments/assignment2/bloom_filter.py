...
def load_bloom_filter(file_path, bloom_filter):
    ...
    with open(file_path, encoding="ISO-8859-1") as file: #loading passwords into an array
        for line in file:
...
def main():
    ...
    #calculate filter size and hash functions count
    ...
    #calculate and display the projected false positive rate
